...
public class CaveBulkerEntity extends TamableAnimal implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1.3, (float) 4, (float) 6, false) {
			@Override
			public boolean canUse() {
				...
				return super.canUse() && CaveBulkerSitProcedure.execute(world);
			}
		});
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.shulker.open")), 0.15f, 1);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CaveBulkerCallProcedure.execute(world, entity, sourceentity);
		return retval;
	}
